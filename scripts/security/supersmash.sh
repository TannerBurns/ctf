...
echo "*/1 * * * * cd /ctf/steak249/flags/; sudo -u a1steaksauce -H /ctf/steak249/home/server.py > /vagrant/cronlogs/steak249_ctf-servers.log 2>&1" >> /vagrant/scripts/security/vagrant_cron
